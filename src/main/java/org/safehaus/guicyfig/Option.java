...
/**
 * An option setOverride used in conjunction with the @Overrides annotation at the
...
public @interface Option {
    /**
     * The name of the configuration interface's property getter to setOverride.
     *
    ...
    /**
     * The value to setOverride with as a String representation. This will be
     * automatically converted to the appropriate type if need be.
     *
     * @return the value to setOverride with
     */
    String override();
}
